...
const FooterEnhanced = () => {
  ...
  return (
    <footer className="relative w-full max-w-[1400px] mx-auto bg-[#050505] text-white overflow-hidden px-6 sm:px-10 md:px-20 py-10 flex flex-col justify-between font-sans border-t border-orange-500/50 rounded-t-[40px] sm:rounded-t-[60px]">
      ...
      <div className="relative z-10 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 mb-10">
      ...
      {/* --- Bottom Section --- */}
      <div className="relative z-10 flex flex-col sm:flex-row justify-between items-center mt-10 border-t border-white/5 pt-6 sm:pt-8 text-xs sm:text-sm text-gray-500 gap-3">
